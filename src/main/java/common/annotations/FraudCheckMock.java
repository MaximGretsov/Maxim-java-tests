...
public @interface FraudCheckMock {
    ...
    /**
     * WireMock behavior for the test
     */
    FraudMockBehavior behavior() default FraudMockBehavior.RESPONSE;
    ...
    /**
     * HTTP status for HTTP_ERROR behavior
     */
    int httpStatus() default 500;

    /**
     * Response delay for TIMEOUT behavior
     */
    int delayMs() default 10000;
