...
public class CreateUserTest {
    ...
    public void adminCanCreateUserTest(){
        ...
        // Шаг 3: Проверка алерта о корректном создании
    ...
    public void adminCannotCreateUserWithInvalidDataTest(){
        ...
        // Шаг 3: Проверка алерта "Username must be between 3 and 15 characters"
        Alert alert = switchTo().alert();
       ...
       long userWithSameUsernameAsNewUser = Arrays.stream(users)
